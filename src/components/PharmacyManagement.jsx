  ...
  const products = [
    {
      id: 1,
      title: 'Logistics',
      description: 'Logistics and supply chain management for pharmacy operations.',
      url: 'https://taiba-logis.vercel.app/'
    },
    {
      id: 2,
      title: 'Customer E-commerce Site',
      description: 'Online storefront for customers to purchase pharmacy products.',
      url: 'https://taiba-gilt.vercel.app/'
    }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600">
            Complete pharmacy management and inventory solutions
          </p>
        </div>
