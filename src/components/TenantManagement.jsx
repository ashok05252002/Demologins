...
const TenantManagement = ({ navigateTo }) => {
  const products = [
    {
      id: 1,
      title: 'Tenant Customer Portal',
      description: 'A dedicated portal for tenants to manage their accounts and services.',
      url: 'https://tenant-pi-three.vercel.app/'
    }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600">
            Streamlined property and tenant management solutions
          </p>
        </div>
