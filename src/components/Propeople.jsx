...
const Propeople = ({ navigateTo }) => {
  const products = [
    {
      id: 1,
      title: 'Propeople',
      description: 'Human resource and personnel management platform.',
      url: 'https://pro-people.vercel.app/'
    },
    {
      id: 2,
      title: 'HRMS Platform',
      description: 'A comprehensive Human Resource Management System.',
      url: 'https://hrms-six-green.vercel.app/'
    }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600">
            Efficiently manage your workforce and HR processes.
          </p>
        </div>
