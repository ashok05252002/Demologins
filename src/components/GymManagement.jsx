...
const GymManagement = ({ navigateTo }) => {
  const products = [
    {
      id: 1,
      title: 'Gym Management System',
      description: 'A complete solution for managing gym operations, members, and schedules.',
      url: 'https://gymm-nu.vercel.app/'
    }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600">
            Comprehensive gym and fitness center management
          </p>
        </div>
